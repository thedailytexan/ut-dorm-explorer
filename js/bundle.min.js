...
return"function"!==n&&!rt.isWindow(t)&&("array"===n||0===e||"number"==typeof e&&e>0&&e-1 in t)}function i(t,e,n){if(rt.isFunction(e))return rt.grep(t,function(t,i){return!!e.call(t,i,t)!==n})
if(e.nodeType)return rt.grep(t,function(t){return t===e!==n})
if("string"==typeof e){if(gt.test(e))return rt.filter(e,t,n)
...
if(void 0===n&&1===t.nodeType)if(i="data-"+e.replace(Dt,"-$&").toLowerCase(),n=t.getAttribute(i),"string"==typeof n){try{n="true"===n||"false"!==n&&("null"===n?null:+n+""===n?+n:$t.test(n)?rt.parseJSON(n):n)}catch(t){}kt.set(t,e,n)}else n=void 0
return n}function u(t,e,n,i){var o,r=1,s=20,a=i?function(){return i.cur()}:function(){return rt.css(t,e,"")},l=a(),u=n&&n[3]||(rt.cssNumber[e]?"":"px"),c=(rt.cssNumber[e]||"px"!==u&&+l)&&At.exec(rt.css(t,e))
if(c&&c[3]!==u){u=u||c[3],n=n||[],c=+l||1
do r=r||".5",c/=r,rt.style(t,e,c+u)
while(r!==(r=a()/l)&&1!==r&&--s)}return n&&(c=+c||+l||0,o=n[1]?c+(n[1]+1)*n[2]:+n[2],i&&(i.unit=u,i.start=c,i.end=o)),o}function c(t,e){var n="undefined"!=typeof t.getElementsByTagName?t.getElementsByTagName(e||"*"):"undefined"!=typeof t.querySelectorAll?t.querySelectorAll(e||"*"):[]
return void 0===e||e&&rt.nodeName(t,e)?rt.merge([t],n):n}function d(t,e){for(var n=0,i=t.length;i>n;n++)St.set(t[n],"globalEval",!e||St.get(e[n],"globalEval"))}function f(t,e,n,i,o){for(var r,s,a,l,u,f,p=e.createDocumentFragment(),h=[],g=0,v=t.length;v>g;g++)if(r=t[g],r||0===r)if("object"===rt.type(r))rt.merge(h,r.nodeType?[r]:r)
else if(Ht.test(r)){for(s=s||p.appendChild(e.createElement("div")),a=(Ot.exec(r)||["",""])[1].toLowerCase(),l=Wt[a]||Wt._default,s.innerHTML=l[1]+rt.htmlPrefilter(r)+l[2],f=l[0];f--;)s=s.lastChild
rt.merge(h,s.childNodes),s=p.firstChild,s.textContent=""}else h.push(e.createTextNode(r))
for(p.textContent="",g=0;r=h[g++];)if(i&&rt.inArray(r,i)>-1)o&&o.push(r)
else if(u=rt.contains(r.ownerDocument,r),s=c(p.appendChild(r),"script"),u&&d(s),n)for(f=0;r=s[f++];)Rt.test(r.type||"")&&n.push(r)
return p}function p(){return!0}function h(){return!1}function g(){try{return Y.activeElement}catch(t){}}function v(t,e,n,i,o,r){var s,a
...
return 1===r&&(s=o,o=function(t){return rt().off(t),s.apply(this,arguments)},o.guid=s.guid||(s.guid=rt.guid++)),t.each(function(){rt.event.add(this,e,o,i,n)})}function y(t,e){return rt.nodeName(t,"table")&&rt.nodeName(11!==e.nodeType?e:e.firstChild,"tr")?t.getElementsByTagName("tbody")[0]||t.appendChild(t.ownerDocument.createElement("tbody")):t}function m(t){return t.type=(null!==t.getAttribute("type"))+"/"+t.type,t}function b(t){var e=_t.exec(t.type)
...
var o,r,s,a,l,u,d=0,p=t.length,h=p-1,g=e[0],v=rt.isFunction(g)
if(v||p>1&&"string"==typeof g&&!it.checkClone&&Ut.test(g))return t.each(function(o){var r=t.eq(o)
v&&(e[0]=g.call(this,o,r.html())),T(r,e,n,i)})
if(p&&(o=f(e,t[0].ownerDocument,!1,t,i),r=o.firstChild,1===o.childNodes.length&&(o=r),r||i)){for(s=rt.map(c(o,"script"),m),a=s.length;p>d;d++)l=o,d!==h&&(l=rt.clone(l,!0,!0),a&&rt.merge(s,c(l,"script"))),n.call(t[d],l,d)
if(a)for(u=s[s.length-1].ownerDocument,rt.map(s,b),d=0;a>d;d++)l=s[d],Rt.test(l.type||"")&&!St.access(l,"globalEval")&&rt.contains(u,l)&&(l.src?rt._evalUrl&&rt._evalUrl(l.src):rt.globalEval(l.textContent.replace(zt,"")))}return t}function C(t,e,n){for(var i,o=e?rt.filter(e,t):t,r=0;null!=(i=o[r]);r++)n||1!==i.nodeType||rt.cleanData(c(i)),i.parentNode&&(n&&rt.contains(i.ownerDocument,i)&&d(c(i,"script")),i.parentNode.removeChild(i))
return t}function E(t,e){var n=rt(e.createElement(t)).appendTo(e.body),i=rt.css(n[0],"display")
return n.detach(),i}function S(t){var e=Y,n=Xt[t]
return n||(n=E(t,e),"none"!==n&&n||(Vt=(Vt||rt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),e=Vt[0].contentDocument,e.write(),e.close(),n=E(t,e),Vt.detach()),Xt[t]=n),n}function k(t,e,n){var i,o,r,s,a=t.style
return n=n||Gt(t),s=n?n.getPropertyValue(e)||n[e]:void 0,""!==s&&void 0!==s||rt.contains(t.ownerDocument,t)||(s=rt.style(t,e)),n&&!it.pixelMarginRight()&&Yt.test(s)&&Qt.test(e)&&(i=a.width,o=a.minWidth,r=a.maxWidth,a.minWidth=a.maxWidth=a.width=s,s=n.width,a.width=i,a.minWidth=o,a.maxWidth=r),void 0!==s?s+"":s}function $(t,e){return{get:function(){return t()?void delete this.get:(this.get=e).apply(this,arguments)}}}function D(t){if(t in ie)return t
for(var e=t[0].toUpperCase()+t.slice(1),n=ne.length;n--;)if(t=ne[n]+e,t in ie)return t}function N(t,e,n){var i=At.exec(e)
return i?Math.max(0,i[2]-(n||0))+(i[3]||"px"):e}function A(t,e,n,i,o){for(var r=n===(i?"border":"content")?4:"width"===e?1:0,s=0;4>r;r+=2)"margin"===n&&(s+=rt.css(t,n+Lt[r],!0,o)),i?("content"===n&&(s-=rt.css(t,"padding"+Lt[r],!0,o)),"margin"!==n&&(s-=rt.css(t,"border"+Lt[r]+"Width",!0,o))):(s+=rt.css(t,"padding"+Lt[r],!0,o),"padding"!==n&&(s+=rt.css(t,"border"+Lt[r]+"Width",!0,o)))
return s}function L(e,n,i){var o=!0,r="width"===n?e.offsetWidth:e.offsetHeight,s=Gt(e),a="border-box"===rt.css(e,"boxSizing",!1,s)
if(Y.msFullscreenElement&&t.top!==t&&e.getClientRects().length&&(r=Math.round(100*e.getBoundingClientRect()[n])),0>=r||null==r){if(r=k(e,n,s),(0>r||null==r)&&(r=e.style[n]),Yt.test(r))return r
o=a&&(it.boxSizingReliable()||r===e.style[n]),r=parseFloat(r)||0}return r+A(e,n,i||(a?"border":"content"),o,s)+"px"}function j(t,e){for(var n,i,o,r=[],s=0,a=t.length;a>s;s++)i=t[s],i.style&&(r[s]=St.get(i,"olddisplay"),n=i.style.display,e?(r[s]||"none"!==n||(i.style.display=""),""===i.style.display&&jt(i)&&(r[s]=St.access(i,"olddisplay",S(i.nodeName)))):(o=jt(i),"none"===n&&o||St.set(i,"olddisplay",o?n:rt.css(i,"display"))))
for(s=0;a>s;s++)i=t[s],i.style&&(e&&"none"!==i.style.display&&""!==i.style.display||(i.style.display=e?r[s]||"":"none"))
return t}function I(t,e,n,i,o){return new I.prototype.init(t,e,n,i,o)}function O(){return t.setTimeout(function(){oe=void 0}),oe=rt.now()}function R(t,e){var n,i=0,o={height:t}
for(e=e?1:0;4>i;i+=2-e)n=Lt[i],o["margin"+n]=o["padding"+n]=t
return e&&(o.opacity=o.width=t),o}function W(t,e,n){for(var i,o=(F.tweeners[e]||[]).concat(F.tweeners["*"]),r=0,s=o.length;s>r;r++)if(i=o[r].call(n,e,t))return i}function H(t,e,n){var i,o,r,s,a,l,u,c,d=this,f={},p=t.style,h=t.nodeType&&jt(t),g=St.get(t,"fxshow")
...
for(i in e)if(o=e[i],se.exec(o)){if(delete e[i],r=r||"toggle"===o,o===(h?"hide":"show")){if("show"!==o||!g||void 0===g[i])continue
h=!0}f[i]=g&&g[i]||rt.style(t,i)}else u=void 0
if(rt.isEmptyObject(f))"inline"===("none"===u?S(t.nodeName):u)&&(p.display=u)
else{g?"hidden"in g&&(h=g.hidden):g=St.access(t,"fxshow",{}),r&&(g.hidden=!h),h?rt(t).show():d.done(function(){rt(t).hide()}),d.done(function(){var e
St.remove(t,"fxshow")
for(e in f)rt.style(t,e,f[e])})
for(i in f)s=W(h?g[i]:0,i,d),i in g||(g[i]=s.start,h&&(s.end=s.start,s.start="width"===i||"height"===i?1:0))}}function q(t,e){var n,i,o,r,s
...
for(n in r)n in t||(t[n]=r[n],e[n]=o)}else e[i]=o}function F(t,e,n){var i,o,r=0,s=F.prefilters.length,a=rt.Deferred().always(function(){delete l.elem}),l=function(){if(o)return!1
for(var e=oe||O(),n=Math.max(0,u.startTime+u.duration-e),i=n/u.duration||0,r=1-i,s=0,l=u.tweens.length;l>s;s++)u.tweens[s].run(r)
...
for(q(c,u.opts.specialEasing);s>r;r++)if(i=F.prefilters[r].call(u,t,c,u.opts))return rt.isFunction(i.stop)&&(rt._queueHooks(u.elem,u.opts.queue).stop=rt.proxy(i.stop,i)),i
return rt.map(c,W,u),rt.isFunction(u.opts.start)&&u.opts.start.call(t,u),rt.fx.timer(rt.extend(l,{elem:t,anim:u,queue:u.opts.queue})),u.progress(u.opts.progress).done(u.opts.done,u.opts.complete).fail(u.opts.fail).always(u.opts.always)}function P(t){return t.getAttribute&&t.getAttribute("class")||""}function B(t){return function(e,n){"string"!=typeof e&&(n=e,e="*")
var i,o=0,r=e.toLowerCase().match(wt)||[]
if(rt.isFunction(n))for(;i=r[o++];)"+"===i[0]?(i=i.slice(1)||"*",(t[i]=t[i]||[]).unshift(n)):(t[i]=t[i]||[]).push(n)}}function M(t,e,n,i){function o(a){var l
...
return o(e.dataTypes[0])||!r["*"]&&o("*")}function U(t,e){var n,i,o=rt.ajaxSettings.flatOptions||{}
for(n in e)void 0!==e[n]&&((o[n]?t:i||(i={}))[n]=e[n])
return i&&rt.extend(!0,t,i),t}function _(t,e,n){for(var i,o,r,s,a=t.contents,l=t.dataTypes;"*"===l[0];)l.shift(),void 0===i&&(i=t.mimeType||e.getResponseHeader("Content-Type"))
if(i)for(o in a)if(a[o]&&a[o].test(i)){l.unshift(o)
break}if(l[0]in n)r=l[0]
else{for(o in n){if(!l[0]||t.converters[o+" "+l[0]]){r=o
break}s||(s=o)}r=r||s}return r?(r!==l[0]&&l.unshift(r),n[r]):void 0}function z(t,e,n,i){var o,r,s,a,l,u={},c=t.dataTypes.slice()
...
else try{e=s(e)}catch(t){return{state:"parsererror",error:s?t:"No conversion from "+l+" to "+r}}}return{state:"success",data:e}}function V(t,e,n,i){var o
if(rt.isArray(e))rt.each(e,function(e,o){n||Ae.test(t)?i(t,o):V(t+"["+("object"==typeof o&&null!=o?e:"")+"]",o,n,i)})
else if(n||"object"!==rt.type(e))i(t,e)
else for(o in e)V(t+"["+o+"]",e[o],n,i)}function X(t){return rt.isWindow(t)?t:9===t.nodeType&&t.defaultView}var Q=[],Y=t.document,G=Q.slice,J=Q.concat,K=Q.push,Z=Q.indexOf,tt={},et=tt.toString,nt=tt.hasOwnProperty,it={},ot="2.2.2",rt=function(t,e){return new rt.fn.init(t,e)},st=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,at=/^-ms-/,lt=/-([\da-z])/gi,ut=function(t,e){return e.toUpperCase()}
...
return this.pushStack(n>=0&&e>n?[this[n]]:[])},end:function(){return this.prevObject||this.constructor()},push:K,sort:Q.sort,splice:Q.splice},rt.extend=rt.fn.extend=function(){var t,e,n,i,o,r,s=arguments[0]||{},a=1,l=arguments.length,u=!1
...
return s},rt.extend({expando:"jQuery"+(ot+Math.random()).replace(/\D/g,""),isReady:!0,error:function(t){throw new Error(t)},noop:function(){},isFunction:function(t){return"function"===rt.type(t)},isArray:Array.isArray,isWindow:function(t){return null!=t&&t===t.window},isNumeric:function(t){var e=t&&t.toString()
...
var ct=function(t){function e(t,e,n,i){var o,r,s,a,l,u,d,p,h=e&&e.ownerDocument,g=e?e.nodeType:9
if(n=n||[],"string"!=typeof t||!t||1!==g&&9!==g&&11!==g)return n
if(!i&&((e?e.ownerDocument||e:P)!==j&&L(e),e=e||j,O)){if(11!==g&&(u=yt.exec(t)))if(o=u[1]){if(9===g){if(!(s=e.getElementById(o)))return n
...
if((o=u[3])&&w.getElementsByClassName&&e.getElementsByClassName)return K.apply(n,e.getElementsByClassName(o)),n}if(w.qsa&&!z[t+" "]&&(!R||!R.test(t))){if(1!==g)h=e,p=t
else if("object"!==e.nodeName.toLowerCase()){for((a=e.getAttribute("id"))?a=a.replace(bt,"\\$&"):e.setAttribute("id",a=F),d=S(t),r=d.length,l=ft.test(a)?"#"+a:"[id='"+a+"']";r--;)d[r]=l+" "+f(d[r])
p=d.join(","),h=mt.test(t)&&c(e.parentNode)||e}if(p)try{return K.apply(n,h.querySelectorAll(p)),n}catch(t){}finally{a===F&&e.removeAttribute("id")}}}return $(t.replace(at,"$1"),e,n,i)}function n(){function t(n,i){return e.push(n+" ")>T.cacheLength&&delete t[e.shift()],t[n+" "]=i}var e=[]
return t}function i(t){return t[F]=!0,t}function o(t){var e=j.createElement("div")
try{return!!t(e)}catch(t){return!1}finally{e.parentNode&&e.parentNode.removeChild(e),e=null}}function r(t,e){for(var n=t.split("|"),i=n.length;i--;)T.attrHandle[n[i]]=e}function s(t,e){var n=e&&t,i=n&&1===t.nodeType&&1===e.nodeType&&(~e.sourceIndex||X)-(~t.sourceIndex||X)
if(i)return i
...
return("input"===n||"button"===n)&&e.type===t}}function u(t){return i(function(e){return e=+e,i(function(n,i){for(var o,r=t([],n.length,e),s=r.length;s--;)n[o=r[s]]&&(n[o]=!(i[o]=n[o]))})})}function c(t){return t&&"undefined"!=typeof t.getElementsByTagName&&t}function d(){}function f(t){for(var e=0,n=t.length,i="";n>e;e++)i+=t[e].value
return i}function p(t,e,n){var i=e.dir,o=n&&"parentNode"===i,r=M++
return e.first?function(e,n,r){for(;e=e[i];)if(1===e.nodeType||o)return t(e,n,r)}:function(e,n,s){var a,l,u,c=[B,r]
if(s){for(;e=e[i];)if((1===e.nodeType||o)&&t(e,n,s))return!0}else for(;e=e[i];)if(1===e.nodeType||o){if(u=e[F]||(e[F]={}),l=u[e.uniqueID]||(u[e.uniqueID]={}),(a=l[i])&&a[0]===B&&a[1]===r)return c[2]=a[2]
if(l[i]=c,c[2]=t(e,n,s))return!0}}}function h(t){return t.length>1?function(e,n,i){for(var o=t.length;o--;)if(!t[o](e,n,i))return!1
return!0}:t[0]}function g(t,n,i){for(var o=0,r=n.length;r>o;o++)e(t,n[o],i)
return i}function v(t,e,n,i,o){for(var r,s=[],a=0,l=t.length,u=null!=e;l>a;a++)(r=t[a])&&(n&&!n(r,i,o)||(s.push(r),u&&e.push(a)))
return s}function y(t,e,n,o,r,s){return o&&!o[F]&&(o=y(o)),r&&!r[F]&&(r=y(r,s)),i(function(i,s,a,l){var u,c,d,f=[],p=[],h=s.length,y=i||g(e||"*",a.nodeType?[a]:a,[]),m=!t||!i&&e?y:v(y,f,t,a,l),b=n?r||(i?t:h||o)?[]:s:m
if(n&&n(m,b,a,l),o)for(u=v(b,p),o(u,[],a,l),c=u.length;c--;)(d=u[c])&&(b[p[c]]=!(m[p[c]]=d))
if(i){if(r||t){if(r){for(u=[],c=b.length;c--;)(d=b[c])&&u.push(m[c]=d)
r(null,b=[],u,l)}for(c=b.length;c--;)(d=b[c])&&(u=r?tt(i,d):f[c])>-1&&(i[u]=!(s[u]=d))}}else b=v(b===s?b.splice(h,b.length):b),r?r(null,s,b,l):K.apply(s,b)})}function m(t){for(var e,n,i,o=t.length,r=T.relative[t[0].type],s=r||T.relative[" "],a=r?1:0,l=p(function(t){return t===e},s,!0),u=p(function(t){return tt(e,t)>-1},s,!0),c=[function(t,n,i){var o=!r&&(i||n!==D)||((e=n).nodeType?l(t,n,i):u(t,n,i))
return e=null,o}];o>a;a++)if(n=T.relative[t[a].type])c=[p(h(c),n)]
else{if(n=T.filter[t[a].type].apply(null,t[a].matches),n[F]){for(i=++a;o>i&&!T.relative[t[i].type];i++);return y(a>1&&h(c),a>1&&f(t.slice(0,a-1).concat({value:" "===t[a-2].type?"*":""})).replace(at,"$1"),n,i>a&&m(t.slice(a,i)),o>i&&m(t=t.slice(i)),o>i&&f(t))}c.push(n)}return h(c)}function b(t,n){var o=n.length>0,r=t.length>0,s=function(i,s,a,l,u){var c,d,f,p=0,h="0",g=i&&[],y=[],m=D,b=i||r&&T.find.TAG("*",u),x=B+=null==m?1:Math.random()||.1,w=b.length
for(u&&(D=s===j||s||u);h!==w&&null!=(c=b[h]);h++){if(r&&c){for(d=0,s||c.ownerDocument===j||(L(c),a=!O);f=t[d++];)if(f(c,s||j,a)){l.push(c)
break}u&&(B=x)}o&&((c=!f&&c)&&p--,i&&g.push(c))}if(p+=h,o&&h!==p){for(d=0;f=n[d++];)f(g,y,s,a)
if(i){if(p>0)for(;h--;)g[h]||y[h]||(y[h]=G.call(l))
y=v(y)}K.apply(l,y),u&&!i&&y.length>0&&p+n.length>1&&e.uniqueSort(l)}return u&&(B=x,D=m),g}
return o?i(s):s}var x,w,T,C,E,S,k,$,D,N,A,L,j,I,O,R,W,H,q,F="sizzle"+1*new Date,P=t.document,B=0,M=0,U=n(),_=n(),z=n(),V=function(t,e){return t===e&&(A=!0),0},X=1<<31,Q={}.hasOwnProperty,Y=[],G=Y.pop,J=Y.push,K=Y.push,Z=Y.slice,tt=function(t,e){for(var n=0,i=t.length;i>n;n++)if(t[n]===e)return n
return-1},et="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",nt="[\\x20\\t\\r\\n\\f]",it="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",ot="\\["+nt+"*("+it+")(?:"+nt+"*([*^$|!~]?=)"+nt+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+it+"))|)"+nt+"*\\]",rt=":("+it+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+ot+")*)|.*)\\)|)",st=new RegExp(nt+"+","g"),at=new RegExp("^"+nt+"+|((?:^|[^\\\\])(?:\\\\.)*)"+nt+"+$","g"),lt=new RegExp("^"+nt+"*,"+nt+"*"),ut=new RegExp("^"+nt+"*([>+~]|"+nt+")"+nt+"*"),ct=new RegExp("="+nt+"*([^\\]'\"]*?)"+nt+"*\\]","g"),dt=new RegExp(rt),ft=new RegExp("^"+it+"$"),pt={ID:new RegExp("^#("+it+")"),CLASS:new RegExp("^\\.("+it+")"),TAG:new RegExp("^("+it+"|[*])"),ATTR:new RegExp("^"+ot),PSEUDO:new RegExp("^"+rt),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+nt+"*(even|odd|(([+-]|)(\\d*)n|)"+nt+"*(?:([+-]|)"+nt+"*(\\d+)|))"+nt+"*\\)|)","i"),bool:new RegExp("^(?:"+et+")$","i"),needsContext:new RegExp("^"+nt+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+nt+"*((?:-\\d)?\\d*)"+nt+"*\\)|)(?=[^-]|$)","i")},ht=/^(?:input|select|textarea|button)$/i,gt=/^h\d$/i,vt=/^[^{]+\{\s*\[native \w/,yt=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,mt=/[+~]/,bt=/'|\\/g,xt=new RegExp("\\\\([\\da-f]{1,6}"+nt+"?|("+nt+")|.)","ig"),wt=function(t,e,n){var i="0x"+e-65536
return i!==i||n?e:0>i?String.fromCharCode(i+65536):String.fromCharCode(i>>10|55296,1023&i|56320)},Tt=function(){L()}
try{K.apply(Y=Z.call(P.childNodes),P.childNodes),Y[P.childNodes.length].nodeType}catch(t){K={apply:Y.length?function(t,e){J.apply(t,Z.call(e))}:function(t,e){for(var n=t.length,i=0;t[n++]=e[i++];);t.length=n-1}}}w=e.support={},E=e.isXML=function(t){var e=t&&(t.ownerDocument||t).documentElement
return!!e&&"HTML"!==e.nodeName},L=e.setDocument=function(t){var e,n,i=t?t.ownerDocument||t:P
return i!==j&&9===i.nodeType&&i.documentElement?(j=i,I=j.documentElement,O=!E(j),(n=j.defaultView)&&n.top!==n&&(n.addEventListener?n.addEventListener("unload",Tt,!1):n.attachEvent&&n.attachEvent("onunload",Tt)),w.attributes=o(function(t){return t.className="i",!t.getAttribute("className")}),w.getElementsByTagName=o(function(t){return t.appendChild(j.createComment("")),!t.getElementsByTagName("*").length}),w.getElementsByClassName=vt.test(j.getElementsByClassName),w.getById=o(function(t){return I.appendChild(t).id=F,!j.getElementsByName||!j.getElementsByName(F).length}),w.getById?(T.find.ID=function(t,e){if("undefined"!=typeof e.getElementById&&O){var n=e.getElementById(t)
...
return n&&n.value===e}}),T.find.TAG=w.getElementsByTagName?function(t,e){return"undefined"!=typeof e.getElementsByTagName?e.getElementsByTagName(t):w.qsa?e.querySelectorAll(t):void 0}:function(t,e){var n,i=[],o=0,r=e.getElementsByTagName(t)
if("*"===t){for(;n=r[o++];)1===n.nodeType&&i.push(n)
return i}return r},T.find.CLASS=w.getElementsByClassName&&function(t,e){return"undefined"!=typeof e.getElementsByClassName&&O?e.getElementsByClassName(t):void 0},W=[],R=[],(w.qsa=vt.test(j.querySelectorAll))&&(o(function(t){I.appendChild(t).innerHTML="<a id='"+F+"'></a><select id='"+F+"-\r\\' msallowcapture=''><option selected=''></option></select>",t.querySelectorAll("[msallowcapture^='']").length&&R.push("[*^$]="+nt+"*(?:''|\"\")"),t.querySelectorAll("[selected]").length||R.push("\\["+nt+"*(?:value|"+et+")"),t.querySelectorAll("[id~="+F+"-]").length||R.push("~="),t.querySelectorAll(":checked").length||R.push(":checked"),t.querySelectorAll("a#"+F+"+*").length||R.push(".#.+[+~]")}),o(function(t){var e=j.createElement("input")
e.setAttribute("type","hidden"),t.appendChild(e).setAttribute("name","D"),t.querySelectorAll("[name=d]").length&&R.push("name"+nt+"*[*^$|!~]?="),t.querySelectorAll(":enabled").length||R.push(":enabled",":disabled"),t.querySelectorAll("*,:x"),R.push(",.*:")})),(w.matchesSelector=vt.test(H=I.matches||I.webkitMatchesSelector||I.mozMatchesSelector||I.oMatchesSelector||I.msMatchesSelector))&&o(function(t){w.disconnectedMatch=H.call(t,"div"),H.call(t,"[s!='']:x"),W.push("!=",rt)}),R=R.length&&new RegExp(R.join("|")),W=W.length&&new RegExp(W.join("|")),e=vt.test(I.compareDocumentPosition),q=e||vt.test(I.contains)?function(t,e){var n=9===t.nodeType?t.documentElement:t,i=e&&e.parentNode
...
return!1},V=e?function(t,e){if(t===e)return A=!0,0
var n=!t.compareDocumentPosition-!e.compareDocumentPosition
return n?n:(n=(t.ownerDocument||t)===(e.ownerDocument||e)?t.compareDocumentPosition(e):1,1&n||!w.sortDetached&&e.compareDocumentPosition(t)===n?t===j||t.ownerDocument===P&&q(P,t)?-1:e===j||e.ownerDocument===P&&q(P,e)?1:N?tt(N,t)-tt(N,e):0:4&n?-1:1)}:function(t,e){if(t===e)return A=!0,0
...
for(;a[i]===l[i];)i++
return i?s(a[i],l[i]):a[i]===P?-1:l[i]===P?1:0},j):j},e.matches=function(t,n){return e(t,null,null,n)},e.matchesSelector=function(t,n){if((t.ownerDocument||t)!==j&&L(t),n=n.replace(ct,"='$1']"),w.matchesSelector&&O&&!z[n+" "]&&(!W||!W.test(n))&&(!R||!R.test(n)))try{var i=H.call(t,n)
if(i||w.disconnectedMatch||t.document&&11!==t.document.nodeType)return i}catch(t){}return e(n,j,null,[t]).length>0},e.contains=function(t,e){return(t.ownerDocument||t)!==j&&L(t),q(t,e)},e.attr=function(t,e){(t.ownerDocument||t)!==j&&L(t)
var n=T.attrHandle[e.toLowerCase()],i=n&&Q.call(T.attrHandle,e.toLowerCase())?n(t,e,!O):void 0
return void 0!==i?i:w.attributes||!O?t.getAttribute(e):(i=t.getAttributeNode(e))&&i.specified?i.value:null},e.error=function(t){throw new Error("Syntax error, unrecognized expression: "+t)},e.uniqueSort=function(t){var e,n=[],i=0,o=0
if(A=!w.detectDuplicates,N=!w.sortStable&&t.slice(0),t.sort(V),A){for(;e=t[o++];)e===t[o]&&(i=n.push(o))
for(;i--;)t.splice(n[i],1)}return N=null,t},C=e.getText=function(t){var e,n="",i=0,o=t.nodeType
...
return pt.CHILD.test(t[0])?null:(t[3]?t[2]=t[4]||t[5]||"":n&&dt.test(n)&&(e=S(n,!0))&&(e=n.indexOf(")",n.length-e)-n.length)&&(t[0]=t[0].slice(0,e),t[2]=n.slice(0,e)),t.slice(0,3))}},filter:{TAG:function(t){var e=t.replace(xt,wt).toLowerCase()
return"*"===t?function(){return!0}:function(t){return t.nodeName&&t.nodeName.toLowerCase()===e}},CLASS:function(t){var e=U[t+" "]
return e||(e=new RegExp("(^|"+nt+")"+t+"("+nt+"|$)"))&&U(t,function(t){return e.test("string"==typeof t.className&&t.className||"undefined"!=typeof t.getAttribute&&t.getAttribute("class")||"")})},ATTR:function(t,n,i){return function(o){var r=e.attr(o,t)
return null==r?"!="===n:!n||(r+="","="===n?r===i:"!="===n?r!==i:"^="===n?i&&0===r.indexOf(i):"*="===n?i&&r.indexOf(i)>-1:"$="===n?i&&r.slice(-i.length)===i:"~="===n?(" "+r.replace(st," ")+" ").indexOf(i)>-1:"|="===n&&(r===i||r.slice(0,i.length+1)===i+"-"))}},CHILD:function(t,e,n,i,o){var r="nth"!==t.slice(0,3),s="last"!==t.slice(-4),a="of-type"===e
return 1===i&&0===o?function(t){return!!t.parentNode}:function(e,n,l){var u,c,d,f,p,h,g=r!==s?"nextSibling":"previousSibling",v=e.parentNode,y=a&&e.nodeName.toLowerCase(),m=!l&&!a,b=!1
if(v){if(r){for(;g;){for(f=e;f=f[g];)if(a?f.nodeName.toLowerCase()===y:1===f.nodeType)return!1
h=g="only"===t&&!h&&"nextSibling"}return!0}if(h=[s?v.firstChild:v.lastChild],s&&m){for(f=v,d=f[F]||(f[F]={}),c=d[f.uniqueID]||(d[f.uniqueID]={}),u=c[t]||[],p=u[0]===B&&u[1],b=p&&u[2],f=p&&v.childNodes[p];f=++p&&f&&f[g]||(b=p=0)||h.pop();)if(1===f.nodeType&&++b&&f===e){c[t]=[B,p,b]
break}}else if(m&&(f=e,d=f[F]||(f[F]={}),c=d[f.uniqueID]||(d[f.uniqueID]={}),u=c[t]||[],p=u[0]===B&&u[1],b=p),b===!1)for(;(f=++p&&f&&f[g]||(b=p=0)||h.pop())&&((a?f.nodeName.toLowerCase()!==y:1!==f.nodeType)||!++b||(m&&(d=f[F]||(f[F]={}),c=d[f.uniqueID]||(d[f.uniqueID]={}),c[t]=[B,b]),f!==e)););return b-=o,b===i||b%i===0&&b/i>=0}}},PSEUDO:function(t,n){var o,r=T.pseudos[t]||T.setFilters[t.toLowerCase()]||e.error("unsupported pseudo: "+t)
return r[F]?r(n):r.length>1?(o=[t,t,"",n],T.setFilters.hasOwnProperty(t.toLowerCase())?i(function(t,e){for(var i,o=r(t,n),s=o.length;s--;)i=tt(t,o[s]),t[i]=!(e[i]=o[s])}):function(t){return r(t,0,o)}):r}},pseudos:{not:i(function(t){var e=[],n=[],o=k(t.replace(at,"$1"))
return o[F]?i(function(t,e,n,i){for(var r,s=o(t,null,i,[]),a=t.length;a--;)(r=s[a])&&(t[a]=!(e[a]=r))}):function(t,i,r){return e[0]=t,o(e,null,r,n),e[0]=null,!n.pop()}}),has:i(function(t){return function(n){return e(t,n).length>0}}),contains:i(function(t){return t=t.replace(xt,wt),function(e){return(e.textContent||e.innerText||C(e)).indexOf(t)>-1}}),lang:i(function(t){return ft.test(t||"")||e.error("unsupported lang: "+t),t=t.replace(xt,wt).toLowerCase(),function(e){var n
...
return n&&n.slice(1)===e.id},root:function(t){return t===I},focus:function(t){return t===j.activeElement&&(!j.hasFocus||j.hasFocus())&&!!(t.type||t.href||~t.tabIndex)},enabled:function(t){return t.disabled===!1},disabled:function(t){return t.disabled===!0},checked:function(t){var e=t.nodeName.toLowerCase()
...
return!0},parent:function(t){return!T.pseudos.empty(t)},header:function(t){return gt.test(t.nodeName)},input:function(t){return ht.test(t.nodeName)},button:function(t){var e=t.nodeName.toLowerCase()
...
return d.prototype=T.filters=T.pseudos,T.setFilters=new d,S=e.tokenize=function(t,n){var i,o,r,s,a,l,u,c=_[t+" "]
...
for(s in T.filter)!(o=pt[s].exec(a))||u[s]&&!(o=u[s](o))||(i=o.shift(),r.push({value:i,type:s,matches:o}),a=a.slice(i.length))
if(!i)break}return n?a.length:a?e.error(t):_(t,l).slice(0)},k=e.compile=function(t,e){var n,i=[],o=[],r=z[t+" "]
if(!r){for(e||(e=S(t)),n=e.length;n--;)r=m(e[n]),r[F]?i.push(r):o.push(r)
r=z(t,b(o,i)),r.selector=t}return r},$=e.select=function(t,e,n,i){var o,r,s,a,l,u="function"==typeof t&&t,d=!i&&S(t=u.selector||t)
if(n=n||[],1===d.length){if(r=d[0]=d[0].slice(0),r.length>2&&"ID"===(s=r[0]).type&&w.getById&&9===e.nodeType&&O&&T.relative[r[1].type]){if(e=(T.find.ID(s.matches[0].replace(xt,wt),e)||[])[0],!e)return n
u&&(e=e.parentNode),t=t.slice(r.shift().value.length)}for(o=pt.needsContext.test(t)?0:r.length;o--&&(s=r[o],!T.relative[a=s.type]);)if((l=T.find[a])&&(i=l(s.matches[0].replace(xt,wt),mt.test(r[0].type)&&c(e.parentNode)||e))){if(r.splice(o,1),t=i.length&&f(r),!t)return K.apply(n,i),n
break}}return(u||k(t,d))(i,e,!O,n,!e||mt.test(t)&&c(e.parentNode)||e),n},w.sortStable=F.split("").sort(V).join("")===F,w.detectDuplicates=!!A,L(),w.sortDetached=o(function(t){return 1&t.compareDocumentPosition(j.createElement("div"))}),o(function(t){return t.innerHTML="<a href='#'></a>","#"===t.firstChild.getAttribute("href")})||r("type|href|height|width",function(t,e,n){return n?void 0:t.getAttribute(e,"type"===e.toLowerCase()?1:2)}),w.attributes&&o(function(t){return t.innerHTML="<input/>",t.firstChild.setAttribute("value",""),""===t.firstChild.getAttribute("value")})||r("value",function(t,e,n){return n||"input"!==t.nodeName.toLowerCase()?void 0:t.defaultValue}),o(function(t){return null==t.getAttribute("disabled")})||r(et,function(t,e,n){var i
...
i.push(t)}return i},ft=function(t,e){for(var n=[];t;t=t.nextSibling)1===t.nodeType&&t!==e&&n.push(t)
return n},pt=rt.expr.match.needsContext,ht=/^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,gt=/^.[^:#\[\.,]*$/
...
return i=this.pushStack(n>1?rt.unique(i):i),i.selector=this.selector?this.selector+" "+t:t,i},filter:function(t){return this.pushStack(i(this,t||[],!1))},not:function(t){return this.pushStack(i(this,t||[],!0))},is:function(t){return!!i(this,"string"==typeof t&&pt.test(t)?rt(t):t||[],!1).length}})
var vt,yt=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,mt=rt.fn.init=function(t,e,n){var i,o
if(!t)return this
if(n=n||vt,"string"==typeof t){if(i="<"===t[0]&&">"===t[t.length-1]&&t.length>=3?[null,t,null]:yt.exec(t),!i||!i[1]&&e)return!e||e.jquery?(e||n).find(t):this.constructor(e).find(t)
...
return this.filter(function(){for(var t=0;n>t;t++)if(rt.contains(this,e[t]))return!0})},closest:function(t,e){for(var n,i=0,o=this.length,r=[],s=pt.test(t)||"string"!=typeof t?rt(t,e||this.context):0;o>i;i++)for(n=this[i];n&&n!==e;n=n.parentNode)if(n.nodeType<11&&(s?s.index(n)>-1:1===n.nodeType&&rt.find.matchesSelector(n,t))){r.push(n)
...
if(s>1)for(e=new Array(s),n=new Array(s),i=new Array(s);s>o;o++)r[o]&&rt.isFunction(r[o].promise)?r[o].promise().progress(u(o,n,e)).done(u(o,i,r)).fail(l.reject):--a
...
var St=new a,kt=new a,$t=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Dt=/[A-Z]/g
...
if(r&&void 0===e){if(n=kt.get(r,t)||kt.get(r,t.replace(Dt,"-$&").toLowerCase()),void 0!==n)return n
...
var Nt=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,At=new RegExp("^(?:([+-])=|)("+Nt+")([a-z%]*)$","i"),Lt=["Top","Right","Bottom","Left"],jt=function(t,e){return t=e||t,"none"===rt.css(t,"display")||!rt.contains(t.ownerDocument,t)},It=/^(?:checkbox|radio)$/i,Ot=/<([\w:-]+)/,Rt=/^$|\/(?:java|ecma)script/i,Wt={option:[1,"<select multiple='multiple'>","</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]}
...
var qt=/^key/,Ft=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,Pt=/^([^.]*)(?:\.(.+)|)/
rt.event={global:{},add:function(t,e,n,i,o){var r,s,a,l,u,c,d,f,p,h,g,v=St.get(t)
if(v)for(n.handler&&(r=n,n=r.handler,o=r.selector),n.guid||(n.guid=rt.guid++),(l=v.events)||(l=v.events={}),(s=v.handle)||(s=v.handle=function(e){return"undefined"!=typeof rt&&rt.event.triggered!==e.type?rt.event.dispatch.apply(t,arguments):void 0}),e=(e||"").match(wt)||[""],u=e.length;u--;)a=Pt.exec(e[u])||[],p=g=a[1],h=(a[2]||"").split(".").sort(),p&&(d=rt.event.special[p]||{},p=(o?d.delegateType:d.bindType)||p,d=rt.event.special[p]||{},c=rt.extend({type:p,origType:g,data:i,handler:n,guid:n.guid,selector:o,needsContext:o&&rt.expr.match.needsContext.test(o),namespace:h.join(".")},r),(f=l[p])||(f=l[p]=[],f.delegateCount=0,d.setup&&d.setup.call(t,i,h,s)!==!1||t.addEventListener&&t.addEventListener(p,s)),d.add&&(d.add.call(t,c),c.handler.guid||(c.handler.guid=n.guid)),o?f.splice(f.delegateCount++,0,c):f.push(c),rt.event.global[p]=!0)},remove:function(t,e,n,i,o){var r,s,a,l,u,c,d,f,p,h,g,v=St.hasData(t)&&St.get(t)
if(v&&(l=v.events)){for(e=(e||"").match(wt)||[""],u=e.length;u--;)if(a=Pt.exec(e[u])||[],p=g=a[1],h=(a[2]||"").split(".").sort(),p){for(d=rt.event.special[p]||{},p=(i?d.delegateType:d.bindType)||p,f=l[p]||[],a=a[2]&&new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),s=r=f.length;r--;)c=f[r],!o&&g!==c.origType||n&&n.guid!==c.guid||a&&!a.test(c.namespace)||i&&i!==c.selector&&("**"!==i||!c.selector)||(f.splice(r,1),c.selector&&f.delegateCount--,d.remove&&d.remove.call(t,c))
s&&!f.length&&(d.teardown&&d.teardown.call(t,h,v.handle)!==!1||rt.removeEvent(t,p,v.handle),delete l[p])}else for(p in l)rt.event.remove(t,p+e[u],n,i,!0)
...
for(s||(this.fixHooks[o]=s=Ft.test(o)?this.mouseHooks:qt.test(o)?this.keyHooks:{}),i=s.props?this.props.concat(s.props):this.props,t=new rt.Event(r),e=i.length;e--;)n=i[e],t[n]=r[n]
return t.target||(t.target=Y),3===t.target.nodeType&&(t.target=t.target.parentNode),s.filter?s.filter(t,r):t},special:{load:{noBubble:!0},focus:{trigger:function(){return this!==g()&&this.focus?(this.focus(),!1):void 0},delegateType:"focusin"},blur:{trigger:function(){return this===g()&&this.blur?(this.blur(),!1):void 0},delegateType:"focusout"},click:{trigger:function(){return"checkbox"===this.type&&this.click&&rt.nodeName(this,"input")?(this.click(),!1):void 0},_default:function(t){return rt.nodeName(t.target,"a")}},beforeunload:{postDispatch:function(t){void 0!==t.result&&t.originalEvent&&(t.originalEvent.returnValue=t.result)}}}},rt.removeEvent=function(t,e,n){t.removeEventListener&&t.removeEventListener(e,n)},rt.Event=function(t,e){return this instanceof rt.Event?(t&&t.type?(this.originalEvent=t,this.type=t.type,this.isDefaultPrevented=t.defaultPrevented||void 0===t.defaultPrevented&&t.returnValue===!1?p:h):this.type=t,e&&rt.extend(this,e),this.timeStamp=t&&t.timeStamp||rt.now(),void(this[rt.expando]=!0)):new rt.Event(t,e)},rt.Event.prototype={constructor:rt.Event,isDefaultPrevented:h,isPropagationStopped:h,isImmediatePropagationStopped:h,preventDefault:function(){var t=this.originalEvent
this.isDefaultPrevented=p,t&&t.preventDefault()},stopPropagation:function(){var t=this.originalEvent
this.isPropagationStopped=p,t&&t.stopPropagation()},stopImmediatePropagation:function(){var t=this.originalEvent
this.isImmediatePropagationStopped=p,t&&t.stopImmediatePropagation(),this.stopPropagation()}},rt.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(t,e){rt.event.special[t]={delegateType:e,bindType:e,handle:function(t){var n,i=this,o=t.relatedTarget,r=t.handleObj
return o&&(o===i||rt.contains(i,o))||(t.type=r.origType,n=r.handler.apply(this,arguments),t.type=e),n}}}),rt.fn.extend({on:function(t,e,n,i){return v(this,t,e,n,i)},one:function(t,e,n,i){return v(this,t,e,n,i,1)},off:function(t,e,n){var i,o
...
var Bt=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,Mt=/<script|<style|<link/i,Ut=/checked\s*(?:[^=]|=\s*.checked.)/i,_t=/^true\/(.*)/,zt=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
rt.extend({htmlPrefilter:function(t){return t.replace(Bt,"<$1></$2>")},clone:function(t,e,n){var i,o,r,s,a=t.cloneNode(!0),l=rt.contains(t.ownerDocument,t)
...
return this},clone:function(t,e){return t=null!=t&&t,e=null==e?t:e,this.map(function(){return rt.clone(this,t,e)})},html:function(t){return Ct(this,function(t){var e=this[0]||{},n=0,i=this.length
if(void 0===t&&1===e.nodeType)return e.innerHTML
if("string"==typeof t&&!Mt.test(t)&&!Wt[(Ot.exec(t)||["",""])[1].toLowerCase()]){t=rt.htmlPrefilter(t)
...
var Vt,Xt={HTML:"block",BODY:"block"},Qt=/^margin/,Yt=new RegExp("^("+Nt+")(?!px)[a-z%]+$","i"),Gt=function(e){var n=e.ownerDocument.defaultView
...
return e=rt.cssProps[a]||(rt.cssProps[a]=D(a)||a),s=rt.cssHooks[e]||rt.cssHooks[a],void 0===n?s&&"get"in s&&void 0!==(o=s.get(t,!1,i))?o:l[e]:(r=typeof n,"string"===r&&(o=At.exec(n))&&o[1]&&(n=u(t,e,o),r="number"),void(null!=n&&n===n&&("number"===r&&(n+=o&&o[3]||(rt.cssNumber[a]?"":"px")),it.clearCloneStyle||""!==n||0!==e.indexOf("background")||(l[e]="inherit"),s&&"set"in s&&void 0===(n=s.set(t,n,i))||(l[e]=n))))}},css:function(t,e,n,i){var o,r,s,a=rt.camelCase(e)
return e=rt.cssProps[a]||(rt.cssProps[a]=D(a)||a),s=rt.cssHooks[e]||rt.cssHooks[a],s&&"get"in s&&(o=s.get(t,!0,n)),void 0===o&&(o=k(t,e,i)),"normal"===o&&e in ee&&(o=ee[e]),""===n||n?(r=parseFloat(o),n===!0||isFinite(r)?r||0:o):o}}),rt.each(["height","width"],function(t,e){rt.cssHooks[e]={get:function(t,n,i){return n?Zt.test(rt.css(t,"display"))&&0===t.offsetWidth?Jt(t,te,function(){return L(t,e,i)}):L(t,e,i):void 0},set:function(t,n,i){var o,r=i&&Gt(t),s=i&&A(t,e,i,"border-box"===rt.css(t,"boxSizing",!1,r),r)
return s&&(o=At.exec(n))&&"px"!==(o[3]||"px")&&(t.style[e]=n,n=rt.css(t,e)),N(t,n,s)}}}),rt.cssHooks.marginLeft=$(it.reliableMarginLeft,function(t,e){return e?(parseFloat(k(t,"marginLeft"))||t.getBoundingClientRect().left-Jt(t,{marginLeft:0},function(){return t.getBoundingClientRect().left}))+"px":void 0}),rt.cssHooks.marginRight=$(it.reliableMarginRight,function(t,e){return e?Jt(t,{display:"inline-block"},k,[t,"marginRight"]):void 0}),rt.each({margin:"",padding:"",border:"Width"},function(t,e){rt.cssHooks[t+e]={expand:function(n){for(var i=0,o={},r="string"==typeof n?n.split(" "):[n];4>i;i++)o[t+Lt[i]+e]=r[i]||r[i-2]||r[0]
return o}},Qt.test(t)||(rt.cssHooks[t+e].set=N)}),rt.fn.extend({css:function(t,e){return Ct(this,function(t,e,n){var i,o,r={},s=0
...
rt.Animation=rt.extend(F,{tweeners:{"*":[function(t,e){var n=this.createTween(t,e)
return u(n.elem,t,At.exec(e),n),n}]},tweener:function(t,e){rt.isFunction(t)?(e=t,t=["*"]):t=t.match(wt)
...
if(3!==r&&8!==r&&2!==r)return 1===r&&rt.isXMLDoc(t)||(e=rt.propFix[e]||e,o=rt.propHooks[e]),void 0!==n?o&&"set"in o&&void 0!==(i=o.set(t,n,e))?i:t[e]=n:o&&"get"in o&&null!==(i=o.get(t,e))?i:t[e]},propHooks:{tabIndex:{get:function(t){var e=rt.find.attr(t,"tabindex")
...
if(rt.isFunction(t))return this.each(function(e){rt(this).addClass(t.call(this,e,P(this)))})
if("string"==typeof t&&t)for(e=t.match(wt)||[];n=this[l++];)if(o=P(n),i=1===n.nodeType&&(" "+o+" ").replace(fe," ")){for(s=0;r=e[s++];)i.indexOf(" "+r+" ")<0&&(i+=r+" ")
a=rt.trim(i),o!==a&&n.setAttribute("class",a)}return this},removeClass:function(t){var e,n,i,o,r,s,a,l=0
if(rt.isFunction(t))return this.each(function(e){rt(this).removeClass(t.call(this,e,P(this)))})
if(!arguments.length)return this.attr("class","")
if("string"==typeof t&&t)for(e=t.match(wt)||[];n=this[l++];)if(o=P(n),i=1===n.nodeType&&(" "+o+" ").replace(fe," ")){for(s=0;r=e[s++];)for(;i.indexOf(" "+r+" ")>-1;)i=i.replace(" "+r+" "," ")
a=rt.trim(i),o!==a&&n.setAttribute("class",a)}return this},toggleClass:function(t,e){var n=typeof t
return"boolean"==typeof e&&"string"===n?e?this.addClass(t):this.removeClass(t):rt.isFunction(t)?this.each(function(n){rt(this).toggleClass(t.call(this,n,P(this),e),e)}):this.each(function(){var e,i,o,r
if("string"===n)for(i=0,o=rt(this),r=t.match(wt)||[];e=r[i++];)o.hasClass(e)?o.removeClass(e):o.addClass(e)
else void 0!==t&&"boolean"!==n||(e=P(this),e&&St.set(this,"__className__",e),this.setAttribute&&this.setAttribute("class",e||t===!1?"":St.get(this,"__className__")||""))})},hasClass:function(t){var e,n,i=0
for(e=" "+t+" ";n=this[i++];)if(1===n.nodeType&&(" "+P(n)+" ").replace(fe," ").indexOf(e)>-1)return!0
return!1}})
var pe=/\r/g,he=/[\x20\t\r\n\f]+/g
rt.fn.extend({val:function(t){var e,n,i,o=this[0]
return arguments.length?(i=rt.isFunction(t),this.each(function(n){var o
1===this.nodeType&&(o=i?t.call(this,n,rt(this).val()):t,null==o?o="":"number"==typeof o?o+="":rt.isArray(o)&&(o=rt.map(o,function(t){return null==t?"":t+""})),e=rt.valHooks[this.type]||rt.valHooks[this.nodeName.toLowerCase()],e&&"set"in e&&void 0!==e.set(this,o,"value")||(this.value=o))})):o?(e=rt.valHooks[o.type]||rt.valHooks[o.nodeName.toLowerCase()],e&&"get"in e&&void 0!==(n=e.get(o,"value"))?n:(n=o.value,"string"==typeof n?n.replace(pe,""):null==n?"":n)):void 0}}),rt.extend({valHooks:{option:{get:function(t){var e=rt.find.attr(t,"value")
...
rt.extend(rt.event,{trigger:function(e,n,i,o){var r,s,a,l,u,c,d,f=[i||Y],p=nt.call(e,"type")?e.type:e,h=nt.call(e,"namespace")?e.namespace.split("."):[]
if(s=a=i=i||Y,3!==i.nodeType&&8!==i.nodeType&&!ge.test(p+rt.event.triggered)&&(p.indexOf(".")>-1&&(h=p.split("."),p=h.shift(),h.sort()),u=p.indexOf(":")<0&&"on"+p,e=e[rt.expando]?e:new rt.Event(p,"object"==typeof e&&e),e.isTrigger=o?2:3,e.namespace=h.join("."),e.rnamespace=e.namespace?new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,e.result=void 0,e.target||(e.target=i),n=null==n?[e]:rt.makeArray(n,[e]),d=rt.event.special[p]||{},o||!d.trigger||d.trigger.apply(i,n)!==!1)){if(!o&&!d.noBubble&&!rt.isWindow(i)){for(l=d.delegateType||p,ge.test(l+p)||(s=s.parentNode);s;s=s.parentNode)f.push(s),a=s
a===(i.ownerDocument||Y)&&f.push(a.defaultView||a.parentWindow||t)}for(r=0;(s=f[r++])&&!e.isPropagationStopped();)e.type=r>1?l:d.bindType||p,c=(St.get(s,"events")||{})[e.type]&&St.get(s,"handle"),c&&c.apply(s,n),c=u&&s[u],c&&c.apply&&Et(s)&&(e.result=c.apply(s,n),e.result===!1&&e.preventDefault())
return e.type=p,o||e.isDefaultPrevented()||d._default&&d._default.apply(f.pop(),n)!==!1||!Et(i)||u&&rt.isFunction(i[p])&&!rt.isWindow(i)&&(a=i[u],a&&(i[u]=null),rt.event.triggered=p,i[p](),rt.event.triggered=void 0,a&&(i[u]=a)),e.result}},simulate:function(t,e,n){var i=rt.extend(new rt.Event,n,{type:t,isSimulated:!0})
rt.event.trigger(i,null,e),i.isDefaultPrevented()&&n.preventDefault()}}),rt.fn.extend({trigger:function(t,e){return this.each(function(){rt.event.trigger(t,e,this)})},triggerHandler:function(t,e){var n=this[0]
...
var ve=t.location,ye=rt.now(),me=/\?/
rt.parseJSON=function(t){return JSON.parse(t+"")},rt.parseXML=function(e){var n
if(!e||"string"!=typeof e)return null
try{n=(new t.DOMParser).parseFromString(e,"text/xml")}catch(t){n=void 0}return n&&!n.getElementsByTagName("parsererror").length||rt.error("Invalid XML: "+e),n}
var be=/#.*$/,xe=/([?&])_=[^&]*/,we=/^(.*?):[ \t]*([^\r\n]*)$/gm,Te=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,Ce=/^(?:GET|HEAD)$/,Ee=/^\/\//,Se={},ke={},$e="*/".concat("*"),De=Y.createElement("a")
De.href=ve.href,rt.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:ve.href,type:"GET",isLocal:Te.test(ve.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":$e,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":rt.parseJSON,"text xml":rt.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(t,e){return e?U(U(t,rt.ajaxSettings),e):U(rt.ajaxSettings,t)},ajaxPrefilter:B(Se),ajaxTransport:B(ke),ajax:function(e,n){function i(e,n,i,a){var u,d,m,b,w,C=n
2!==x&&(x=2,l&&t.clearTimeout(l),o=void 0,s=a||"",T.readyState=e>0?4:0,u=e>=200&&300>e||304===e,i&&(b=_(f,T,i)),b=z(f,b,T,u),u?(f.ifModified&&(w=T.getResponseHeader("Last-Modified"),w&&(rt.lastModified[r]=w),w=T.getResponseHeader("etag"),w&&(rt.etag[r]=w)),204===e||"HEAD"===f.type?C="nocontent":304===e?C="notmodified":(C=b.state,d=b.data,m=b.error,u=!m)):(m=C,!e&&C||(C="error",0>e&&(e=0))),T.status=e,T.statusText=(n||C)+"",u?g.resolveWith(p,[d,C,T]):g.rejectWith(p,[T,C,m]),T.statusCode(y),y=void 0,c&&h.trigger(u?"ajaxSuccess":"ajaxError",[T,f,u?d:m]),v.fireWith(p,[T,C]),c&&(h.trigger("ajaxComplete",[T,f]),--rt.active||rt.event.trigger("ajaxStop")))}"object"==typeof e&&(n=e,e=void 0),n=n||{}
var o,r,s,a,l,u,c,d,f=rt.ajaxSetup({},n),p=f.context||f,h=f.context&&(p.nodeType||p.jquery)?rt(p):rt.event,g=rt.Deferred(),v=rt.Callbacks("once memory"),y=f.statusCode||{},m={},b={},x=0,w="canceled",T={readyState:0,getResponseHeader:function(t){var e
...
return x||(t=b[n]=b[n]||t,m[t]=e),this},overrideMimeType:function(t){return x||(f.mimeType=t),this},statusCode:function(t){var e
if(t)if(2>x)for(e in t)y[e]=[y[e],t[e]]
else T.always(t[T.status])
return this},abort:function(t){var e=t||w
return o&&o.abort(e),i(0,e),this}}
if(g.promise(T).complete=v.add,T.success=T.done,T.error=T.fail,f.url=((e||f.url||ve.href)+"").replace(be,"").replace(Ee,ve.protocol+"//"),f.type=n.method||n.type||f.method||f.type,f.dataTypes=rt.trim(f.dataType||"*").toLowerCase().match(wt)||[""],null==f.crossDomain){u=Y.createElement("a")
try{u.href=f.url,u.href=u.href,f.crossDomain=De.protocol+"//"+De.host!=u.protocol+"//"+u.host}catch(t){f.crossDomain=!0}}if(f.data&&f.processData&&"string"!=typeof f.data&&(f.data=rt.param(f.data,f.traditional)),M(Se,f,n,T),2===x)return T
c=rt.event&&f.global,c&&0===rt.active++&&rt.event.trigger("ajaxStart"),f.type=f.type.toUpperCase(),f.hasContent=!Ce.test(f.type),r=f.url,f.hasContent||(f.data&&(r=f.url+=(me.test(r)?"&":"?")+f.data,delete f.data),f.cache===!1&&(f.url=xe.test(r)?r.replace(xe,"$1_="+ye++):r+(me.test(r)?"&":"?")+"_="+ye++)),f.ifModified&&(rt.lastModified[r]&&T.setRequestHeader("If-Modified-Since",rt.lastModified[r]),rt.etag[r]&&T.setRequestHeader("If-None-Match",rt.etag[r])),(f.data&&f.hasContent&&f.contentType!==!1||n.contentType)&&T.setRequestHeader("Content-Type",f.contentType),T.setRequestHeader("Accept",f.dataTypes[0]&&f.accepts[f.dataTypes[0]]?f.accepts[f.dataTypes[0]]+("*"!==f.dataTypes[0]?", "+$e+"; q=0.01":""):f.accepts["*"])
...
if(o=M(ke,f,n,T)){if(T.readyState=1,c&&h.trigger("ajaxSend",[T,f]),2===x)return T
f.async&&f.timeout>0&&(l=t.setTimeout(function(){T.abort("timeout")},f.timeout))
try{x=1,o.send(m,i)}catch(t){if(!(2>x))throw t
...
var Ne=/%20/g,Ae=/\[\]$/,Le=/\r?\n/g,je=/^(?:submit|button|image|reset|file)$/i,Ie=/^(?:input|select|textarea|keygen)/i
...
return i.join("&").replace(Ne,"+")},rt.fn.extend({serialize:function(){return rt.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var t=rt.prop(this,"elements")
return t?rt.makeArray(t):this}).filter(function(){var t=this.type
return this.name&&!rt(this).is(":disabled")&&Ie.test(this.nodeName)&&!je.test(t)&&(this.checked||!It.test(t))}).map(function(t,e){var n=rt(this).val()
return null==n?null:rt.isArray(n)?rt.map(n,function(t){return{name:e.name,value:t.replace(Le,"\r\n")}}):{name:e.name,value:n.replace(Le,"\r\n")}}).get()}}),rt.ajaxSettings.xhr=function(){try{return new t.XMLHttpRequest}catch(t){}}
var Oe={0:200,1223:204},Re=rt.ajaxSettings.xhr()
it.cors=!!Re&&"withCredentials"in Re,it.ajax=Re=!!Re,rt.ajaxTransport(function(e){var n,i
return it.cors||Re&&!e.crossDomain?{send:function(o,r){var s,a=e.xhr()
if(a.open(e.type,e.url,e.async,e.username,e.password),e.xhrFields)for(s in e.xhrFields)a[s]=e.xhrFields[s]
e.mimeType&&a.overrideMimeType&&a.overrideMimeType(e.mimeType),e.crossDomain||o["X-Requested-With"]||(o["X-Requested-With"]="XMLHttpRequest")
for(s in o)a.setRequestHeader(s,o[s])
n=function(t){return function(){n&&(n=i=a.onload=a.onerror=a.onabort=a.onreadystatechange=null,"abort"===t?a.abort():"error"===t?"number"!=typeof a.status?r(0,"error"):r(a.status,a.statusText):r(Oe[a.status]||a.status,a.statusText,"text"!==(a.responseType||"text")||"string"!=typeof a.responseText?{binary:a.response}:{text:a.responseText},a.getAllResponseHeaders()))}},a.onload=n(),i=a.onerror=n("error"),void 0!==a.onabort?a.onabort=i:a.onreadystatechange=function(){4===a.readyState&&t.setTimeout(function(){n&&i()})},n=n("abort")
...
var We=[],He=/(=)\?(?=&|$)|\?\?/
rt.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var t=We.pop()||rt.expando+"_"+ye++
...
return a||"jsonp"===e.dataTypes[0]?(o=e.jsonpCallback=rt.isFunction(e.jsonpCallback)?e.jsonpCallback():e.jsonpCallback,a?e[a]=e[a].replace(He,"$1"+o):e.jsonp!==!1&&(e.url+=(me.test(e.url)?"&":"?")+e.jsonp+"="+o),e.converters["script json"]=function(){return s||rt.error(o+" was not called"),s[0]},e.dataTypes[0]="json",r=t[o],t[o]=function(){s=arguments},i.always(function(){void 0===r?rt(t).removeProp(o):t[o]=r,e[o]&&(e.jsonpCallback=n.jsonpCallback,We.push(o)),s&&rt.isFunction(r)&&r(s[0]),s=r=void 0}),"script"):void 0}),rt.parseHTML=function(t,e,n){if(!t||"string"!=typeof t)return null
"boolean"==typeof e&&(n=e,e=!1),e=e||Y
var i=ht.exec(t),o=!n&&[]
return i?[e.createElement(i[1])]:(i=f([t],e,o),o&&o.length&&rt(o).remove(),rt.merge([],i.childNodes))}
var qe=rt.fn.load
rt.fn.load=function(t,e,n){if("string"!=typeof t&&qe)return qe.apply(this,arguments)
var i,o,r,s=this,a=t.indexOf(" ")
return a>-1&&(i=rt.trim(t.slice(a)),t=t.slice(0,a)),rt.isFunction(e)?(n=e,e=void 0):e&&"object"==typeof e&&(o="POST"),s.length>0&&rt.ajax({url:t,type:o||"GET",dataType:"html",data:e}).done(function(t){r=arguments,s.html(i?rt("<div>").append(rt.parseHTML(t)).find(i):t)}).always(n&&function(t,e){s.each(function(){n.apply(s,r||[t.responseText,e,t])})}),this},rt.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(t,e){rt.fn[e]=function(t){return this.on(e,t)}}),rt.expr.filters.animated=function(t){return rt.grep(rt.timers,function(e){return t===e.elem}).length},rt.offset={setOffset:function(t,e,n){var i,o,r,s,a,l,u,c=rt.css(t,"position"),d=rt(t),f={}
"static"===c&&(t.style.position="relative"),a=d.offset(),r=rt.css(t,"top"),l=rt.css(t,"left"),u=("absolute"===c||"fixed"===c)&&(r+l).indexOf("auto")>-1,u?(i=d.position(),s=i.top,o=i.left):(s=parseFloat(r)||0,o=parseFloat(l)||0),rt.isFunction(e)&&(e=e.call(t,n,rt.extend({},a))),null!=e.top&&(f.top=e.top-a.top+s),null!=e.left&&(f.left=e.left-a.left+o),"using"in e?e.using.call(t,f):d.css(f)}},rt.fn.extend({offset:function(t){if(arguments.length)return void 0===t?this:this.each(function(e){rt.offset.setOffset(this,t,e)})
var e,n,i=this[0],o={top:0,left:0},r=i&&i.ownerDocument
return r?(e=r.documentElement,rt.contains(e,i)?(o=i.getBoundingClientRect(),n=X(r),{top:o.top+n.pageYOffset-e.clientTop,left:o.left+n.pageXOffset-e.clientLeft}):o):void 0},position:function(){if(this[0]){var t,e,n=this[0],i={top:0,left:0}
...
rt.fn[t]=function(i){return Ct(this,function(t,i,o){var r=X(t)
...
var Fe=t.jQuery,Pe=t.$
return rt.noConflict=function(e){return t.$===rt&&(t.$=Pe),e&&t.jQuery===rt&&(t.jQuery=Fe),rt},e||(t.jQuery=t.$=rt),rt}),"undefined"==typeof jQuery)throw new Error("Bootstrap's JavaScript requires jQuery");+function(t){"use strict"
...
d&&d.addClass("active")}var f=t.Event("slid.bs.carousel",{relatedTarget:u,direction:a})
...
var c=this.getPosition(),d=r[0].offsetWidth,f=r[0].offsetHeight
if(u){var p=a,h=this.getPosition(this.$viewport)
a="bottom"==a&&c.bottom+f>h.bottom?"top":"top"==a&&c.top-f<h.top?"bottom":"right"==a&&c.right+d>h.width?"left":"left"==a&&c.left-d<h.left?"right":a,r.removeClass(p).addClass(a)}var g=this.getCalculatedOffset(a,c,d,f)
this.applyPlacement(g,a)
var v=function(){var t=o.hoverState
o.$element.trigger("shown.bs."+o.type),o.hoverState=null,"out"==t&&o.leave(o)}
t.support.transition&&this.$tip.hasClass("fade")?r.one("bsTransitionEnd",v).emulateTransitionEnd(n.TRANSITION_DURATION):v()}},n.prototype.applyPlacement=function(e,n){var i=this.tip(),o=i[0].offsetWidth,r=i[0].offsetHeight,s=parseInt(i.css("margin-top"),10),a=parseInt(i.css("margin-left"),10)
...
var d=/top|bottom/.test(n),f=d?2*c.left-o+l:2*c.top-r+u,p=d?"offsetWidth":"offsetHeight"
i.offset(e),this.replaceArrow(f,i[0][p],d)},n.prototype.replaceArrow=function(t,e,n){this.arrow().css(n?"left":"top",50*(1-t/e)+"%").css(n?"top":"left","")},n.prototype.setContent=function(){var t=this.tip(),e=this.getTitle()
...
return null!=n&&n>=o?"top":null!=i&&l+u>=t-i&&"bottom"},n.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset
...
i.offset=i.offset||{},null!=i.offsetBottom&&(i.offset.bottom=i.offsetBottom),null!=i.offsetTop&&(i.offset.top=i.offsetTop),e.call(n,i)})})}(jQuery),!function(){window.flexibility={},Array.prototype.forEach||(Array.prototype.forEach=function(t){if(void 0===this||null===this)throw new TypeError(this+"is not an object")
if(!(t instanceof Function))throw new TypeError(t+" is not a function")
for(var e=Object(this),n=arguments[1],i=e instanceof String?e.split(""):e,o=Math.max(Math.min(i.length,9007199254740991),0)||0,r=-1;++r<o;)r in i&&t.call(n,i[r],r,e)}),function(t,e){"function"==typeof define&&define.amd?define([],e):"object"==typeof exports?module.exports=e():t.computeLayout=e()}(flexibility,function(){var t=function(){function t(e){if((!e.layout||e.isDirty)&&(e.layout={width:void 0,height:void 0,top:0,left:0,right:0,bottom:0}),e.style||(e.style={}),e.children||(e.children=[]),e.style.measure&&e.children&&e.children.length)throw new Error("Using custom measure function is supported only for leaf nodes.")
return e.children.forEach(t),e}function e(t){return void 0===t}function n(t){return t===B||t===M}function i(t){return t===U||t===_}function o(t,e){if(void 0!==t.style.marginStart&&n(e))return t.style.marginStart
var i=null
switch(e){case"row":i=t.style.marginLeft
break
case"row-reverse":i=t.style.marginRight
break
case"column":i=t.style.marginTop
break
case"column-reverse":i=t.style.marginBottom}return void 0!==i?i:void 0!==t.style.margin?t.style.margin:0}function r(t,e){if(void 0!==t.style.marginEnd&&n(e))return t.style.marginEnd
var i=null
switch(e){case"row":i=t.style.marginRight
break
case"row-reverse":i=t.style.marginLeft
break
case"column":i=t.style.marginBottom
break
case"column-reverse":i=t.style.marginTop}return null!=i?i:void 0!==t.style.margin?t.style.margin:0}function s(t,e){if(void 0!==t.style.paddingStart&&t.style.paddingStart>=0&&n(e))return t.style.paddingStart
var i=null
switch(e){case"row":i=t.style.paddingLeft
break
case"row-reverse":i=t.style.paddingRight
break
case"column":i=t.style.paddingTop
break
case"column-reverse":i=t.style.paddingBottom}return null!=i&&i>=0?i:void 0!==t.style.padding&&t.style.padding>=0?t.style.padding:0}function a(t,e){if(void 0!==t.style.paddingEnd&&t.style.paddingEnd>=0&&n(e))return t.style.paddingEnd
var i=null
switch(e){case"row":i=t.style.paddingRight
break
case"row-reverse":i=t.style.paddingLeft
break
case"column":i=t.style.paddingBottom
break
case"column-reverse":i=t.style.paddingTop}return null!=i&&i>=0?i:void 0!==t.style.padding&&t.style.padding>=0?t.style.padding:0}function l(t,e){if(void 0!==t.style.borderStartWidth&&t.style.borderStartWidth>=0&&n(e))return t.style.borderStartWidth
var i=null
switch(e){case"row":i=t.style.borderLeftWidth
break
case"row-reverse":i=t.style.borderRightWidth
break
case"column":i=t.style.borderTopWidth
break
case"column-reverse":i=t.style.borderBottomWidth}return null!=i&&i>=0?i:void 0!==t.style.borderWidth&&t.style.borderWidth>=0?t.style.borderWidth:0}function u(t,e){if(void 0!==t.style.borderEndWidth&&t.style.borderEndWidth>=0&&n(e))return t.style.borderEndWidth
var i=null
switch(e){case"row":i=t.style.borderRightWidth
break
case"row-reverse":i=t.style.borderLeftWidth
break
case"column":i=t.style.borderBottomWidth
break
case"column-reverse":i=t.style.borderTopWidth}return null!=i&&i>=0?i:void 0!==t.style.borderWidth&&t.style.borderWidth>=0?t.style.borderWidth:0}function c(t,e){return s(t,e)+l(t,e)}function d(t,e){return a(t,e)+u(t,e)}function f(t,e){return l(t,e)+u(t,e)}function p(t,e){return o(t,e)+r(t,e)}function h(t,e){return c(t,e)+d(t,e)}function g(t){return t.style.justifyContent?t.style.justifyContent:"flex-start"}function v(t){return t.style.alignContent?t.style.alignContent:"flex-start"}function y(t,e){return e.style.alignSelf?e.style.alignSelf:t.style.alignItems?t.style.alignItems:"stretch"}function m(t,e){if(e===P){if(t===B)return M
if(t===M)return B}return t}function b(t,e){var n
return n=t.style.direction?t.style.direction:q,n===q&&(n=void 0===e?F:e),n}function x(t){return t.style.flexDirection?t.style.flexDirection:U}function w(t,e){return i(t)?m(B,e):U}function T(t){return t.style.position?t.style.position:"relative"}function C(t){return T(t)===tt&&t.style.flex>0}function E(t){return"wrap"===t.style.flexWrap}function S(t,e){return t.layout[rt[e]]+p(t,e)}function k(t,e){return void 0!==t.style[rt[e]]&&t.style[rt[e]]>=0}function $(t,e){return void 0!==t.style[e]}function D(t){return void 0!==t.style.measure}function N(t,e){return void 0!==t.style[e]?t.style[e]:0}function A(t,e,n){var i={row:t.style.minWidth,"row-reverse":t.style.minWidth,column:t.style.minHeight,"column-reverse":t.style.minHeight}[e],o={row:t.style.maxWidth,"row-reverse":t.style.maxWidth,column:t.style.maxHeight,"column-reverse":t.style.maxHeight}[e],r=n
return void 0!==o&&o>=0&&r>o&&(r=o),void 0!==i&&i>=0&&i>r&&(r=i),r}function L(t,e){return t>e?t:e}function j(t,e){void 0===t.layout[rt[e]]&&k(t,e)&&(t.layout[rt[e]]=L(A(t,e,t.style[rt[e]]),h(t,e)))}function I(t,e,n){e.layout[it[n]]=t.layout[rt[n]]-e.layout[rt[n]]-e.layout[ot[n]]}function O(t,e){return void 0!==t.style[nt[e]]?N(t,nt[e]):-N(t,it[e])}function R(t,i,s,a){var u=b(t,a),R=m(x(t),u),q=w(R,u),F=m(B,u)
j(t,R),j(t,q),t.layout.direction=u,t.layout[nt[R]]+=o(t,R)+O(t,R),t.layout[it[R]]+=r(t,R)+O(t,R),t.layout[nt[q]]+=o(t,q)+O(t,q),t.layout[it[q]]+=r(t,q)+O(t,q)
var P=t.children.length,st=h(t,F),at=h(t,U)
if(D(t)){var lt=!e(t.layout[rt[F]]),ut=H
ut=k(t,F)?t.style.width:lt?t.layout[rt[F]]:i-p(t,F),ut-=st
var ct=H
ct=k(t,U)?t.style.height:e(t.layout[rt[U]])?s-p(t,F):t.layout[rt[U]],ct-=h(t,U)
var dt=!k(t,F)&&!lt,ft=!k(t,U)&&e(t.layout[rt[U]])
if(dt||ft){var pt=t.style.measure(ut,ct)
dt&&(t.layout.width=pt.width+st),ft&&(t.layout.height=pt.height+at)}if(0===P)return}var ht,gt,vt,yt,mt=E(t),bt=g(t),xt=c(t,R),wt=c(t,q),Tt=h(t,R),Ct=h(t,q),Et=!e(t.layout[rt[R]]),St=!e(t.layout[rt[q]]),kt=n(R),$t=null,Dt=null,Nt=H
Et&&(Nt=t.layout[rt[R]]-Tt)
for(var At=0,Lt=0,jt=0,It=0,Ot=0,Rt=0;P>Lt;){var Wt,Ht,qt=0,Ft=0,Pt=0,Bt=0,Mt=Et&&bt===z||!Et&&bt!==V,Ut=Mt?P:At,_t=!0,zt=P,Vt=null,Xt=null,Qt=xt,Yt=0
for(ht=At;P>ht;++ht){vt=t.children[ht],vt.lineIndex=Rt,vt.nextAbsoluteChild=null,vt.nextFlexChild=null
var Gt=y(t,vt)
if(Gt===Z&&T(vt)===tt&&St&&!k(vt,q))vt.layout[rt[q]]=L(A(vt,q,t.layout[rt[q]]-Ct-p(vt,q)),h(vt,q))
else if(T(vt)===et)for(null===$t&&($t=vt),null!==Dt&&(Dt.nextAbsoluteChild=vt),Dt=vt,gt=0;2>gt;gt++)yt=0!==gt?B:U,!e(t.layout[rt[yt]])&&!k(vt,yt)&&$(vt,nt[yt])&&$(vt,it[yt])&&(vt.layout[rt[yt]]=L(A(vt,yt,t.layout[rt[yt]]-h(t,yt)-p(vt,yt)-N(vt,nt[yt])-N(vt,it[yt])),h(vt,yt)))
var Jt=0
if(Et&&C(vt)?(Ft++,Pt+=vt.style.flex,null===Vt&&(Vt=vt),null!==Xt&&(Xt.nextFlexChild=vt),Xt=vt,Jt=h(vt,R)+p(vt,R)):(Wt=H,Ht=H,kt?Ht=k(t,U)?t.layout[rt[U]]-at:s-p(t,U)-at:Wt=k(t,F)?t.layout[rt[F]]-st:i-p(t,F)-st,0===jt&&W(vt,Wt,Ht,u),T(vt)===tt&&(Bt++,Jt=S(vt,R))),mt&&Et&&qt+Jt>Nt&&ht!==At){Bt--,jt=1
break}Mt&&(T(vt)!==tt||C(vt))&&(Mt=!1,Ut=ht),_t&&(T(vt)!==tt||Gt!==Z&&Gt!==G||e(vt.layout[rt[q]]))&&(_t=!1,zt=ht),Mt&&(vt.layout[ot[R]]+=Qt,Et&&I(t,vt,R),Qt+=S(vt,R),Yt=L(Yt,A(vt,q,S(vt,q)))),_t&&(vt.layout[ot[q]]+=It+wt,St&&I(t,vt,q)),jt=0,qt+=Jt,Lt=ht+1}var Kt=0,Zt=0,te=0
if(te=Et?Nt-qt:L(qt,0)-qt,0!==Ft){var ee,ne,ie=te/Pt
for(Xt=Vt;null!==Xt;)ee=ie*Xt.style.flex+h(Xt,R),ne=A(Xt,R,ee),ee!==ne&&(te-=ne,Pt-=Xt.style.flex),Xt=Xt.nextFlexChild
for(ie=te/Pt,0>ie&&(ie=0),Xt=Vt;null!==Xt;)Xt.layout[rt[R]]=A(Xt,R,ie*Xt.style.flex+h(Xt,R)),Wt=H,k(t,F)?Wt=t.layout[rt[F]]-st:kt||(Wt=i-p(t,F)-st),Ht=H,k(t,U)?Ht=t.layout[rt[U]]-at:kt&&(Ht=s-p(t,U)-at),W(Xt,Wt,Ht,u),vt=Xt,Xt=Xt.nextFlexChild,vt.nextFlexChild=null}else bt!==z&&(bt===V?Kt=te/2:bt===X?Kt=te:bt===Q?(te=L(te,0),Zt=Ft+Bt-1!==0?te/(Ft+Bt-1):0):bt===Y&&(Zt=te/(Ft+Bt),Kt=Zt/2))
for(Qt+=Kt,ht=Ut;Lt>ht;++ht)vt=t.children[ht],T(vt)===et&&$(vt,nt[R])?vt.layout[ot[R]]=N(vt,nt[R])+l(t,R)+o(vt,R):(vt.layout[ot[R]]+=Qt,Et&&I(t,vt,R),T(vt)===tt&&(Qt+=Zt+S(vt,R),Yt=L(Yt,A(vt,q,S(vt,q)))))
var oe=t.layout[rt[q]]
for(St||(oe=L(A(t,q,Yt+Ct),Ct)),ht=zt;Lt>ht;++ht)if(vt=t.children[ht],T(vt)===et&&$(vt,nt[q]))vt.layout[ot[q]]=N(vt,nt[q])+l(t,q)+o(vt,q)
else{var re=wt
if(T(vt)===tt){var Gt=y(t,vt)
if(Gt===Z)e(vt.layout[rt[q]])&&(vt.layout[rt[q]]=L(A(vt,q,oe-Ct-p(vt,q)),h(vt,q)))
else if(Gt!==G){var se=oe-Ct-S(vt,q)
re+=Gt===J?se/2:se}}vt.layout[ot[q]]+=It+re,St&&I(t,vt,q)}It+=Yt,Ot=L(Ot,Qt),Rt+=1,At=Lt}if(Rt>1&&St){var ae=t.layout[rt[q]]-Ct,le=ae-It,ue=0,ce=wt,de=v(t)
de===K?ce+=le:de===J?ce+=le/2:de===Z&&ae>It&&(ue=le/Rt)
var fe=0
for(ht=0;Rt>ht;++ht){var pe=fe,he=0
for(gt=pe;P>gt;++gt)if(vt=t.children[gt],T(vt)===tt){if(vt.lineIndex!==ht)break
e(vt.layout[rt[q]])||(he=L(he,vt.layout[rt[q]]+p(vt,q)))}for(fe=gt,he+=ue,gt=pe;fe>gt;++gt)if(vt=t.children[gt],T(vt)===tt){var ge=y(t,vt)
if(ge===G)vt.layout[ot[q]]=ce+o(vt,q)
else if(ge===K)vt.layout[ot[q]]=ce+he-r(vt,q)-vt.layout[rt[q]]
else if(ge===J){var ve=vt.layout[rt[q]]
vt.layout[ot[q]]=ce+(he-ve)/2}else ge===Z&&(vt.layout[ot[q]]=ce+o(vt,q))}ce+=he}}var ye=!1,me=!1
if(Et||(t.layout[rt[R]]=L(A(t,R,Ot+d(t,R)),Tt),(R===M||R===_)&&(ye=!0)),St||(t.layout[rt[q]]=L(A(t,q,It+Ct),Ct),(q===M||q===_)&&(me=!0)),ye||me)for(ht=0;P>ht;++ht)vt=t.children[ht],ye&&I(t,vt,R),me&&I(t,vt,q)
for(Dt=$t;null!==Dt;){for(gt=0;2>gt;gt++)yt=0!==gt?B:U,!e(t.layout[rt[yt]])&&!k(Dt,yt)&&$(Dt,nt[yt])&&$(Dt,it[yt])&&(Dt.layout[rt[yt]]=L(A(Dt,yt,t.layout[rt[yt]]-f(t,yt)-p(Dt,yt)-N(Dt,nt[yt])-N(Dt,it[yt])),h(Dt,yt))),$(Dt,it[yt])&&!$(Dt,nt[yt])&&(Dt.layout[nt[yt]]=t.layout[rt[yt]]-Dt.layout[rt[yt]]-N(Dt,it[yt]))
vt=Dt,Dt=Dt.nextAbsoluteChild,vt.nextAbsoluteChild=null}}function W(t,e,n,i){t.shouldUpdate=!0
var o=t.style.direction||F,r=!t.isDirty&&t.lastLayout&&t.lastLayout.requestedHeight===t.layout.height&&t.lastLayout.requestedWidth===t.layout.width&&t.lastLayout.parentMaxWidth===e&&t.lastLayout.parentMaxHeight===n&&t.lastLayout.direction===o
r?(t.layout.width=t.lastLayout.width,t.layout.height=t.lastLayout.height,t.layout.top=t.lastLayout.top,t.layout.left=t.lastLayout.left):(t.lastLayout||(t.lastLayout={}),t.lastLayout.requestedWidth=t.layout.width,t.lastLayout.requestedHeight=t.layout.height,t.lastLayout.parentMaxWidth=e,t.lastLayout.parentMaxHeight=n,t.lastLayout.direction=o,t.children.forEach(function(t){t.layout.width=void 0,t.layout.height=void 0,t.layout.top=0,t.layout.left=0}),R(t,e,n,i),t.lastLayout.width=t.layout.width,t.lastLayout.height=t.layout.height,t.lastLayout.top=t.layout.top,t.lastLayout.left=t.layout.left)}var H,q="inherit",F="ltr",P="rtl",B="row",M="row-reverse",U="column",_="column-reverse",z="flex-start",V="center",X="flex-end",Q="space-between",Y="space-around",G="flex-start",J="center",K="flex-end",Z="stretch",tt="relative",et="absolute",nt={row:"left","row-reverse":"right",column:"top","column-reverse":"bottom"},it={row:"right","row-reverse":"left",column:"bottom","column-reverse":"top"},ot={row:"left","row-reverse":"right",column:"top","column-reverse":"bottom"},rt={row:"width","row-reverse":"width",column:"height","column-reverse":"height"}
return{layoutNodeImpl:R,computeLayout:W,fillNodes:t}}()
return"object"==typeof exports&&(module.exports=t),function(e){t.fillNodes(e),t.computeLayout(e)}}),!window.addEventListener&&window.attachEvent&&function(){Window.prototype.addEventListener=HTMLDocument.prototype.addEventListener=Element.prototype.addEventListener=function(t,e){this.attachEvent("on"+t,e)},Window.prototype.removeEventListener=HTMLDocument.prototype.removeEventListener=Element.prototype.removeEventListener=function(t,e){this.detachEvent("on"+t,e)}}(),flexibility.detect=function(){var t=document.createElement("p")
try{return t.style.display="flex","flex"===t.style.display}catch(t){return!1}},!flexibility.detect()&&document.attachEvent&&document.documentElement.currentStyle&&document.attachEvent("onreadystatechange",function(){flexibility.onresize({target:document.documentElement})}),flexibility.init=function(t){var e=t.onlayoutcomplete
return e||(e=t.onlayoutcomplete={node:t,style:{},children:[]}),e.style.display=t.currentStyle["-js-display"]||t.currentStyle.display,e}
var t,e=1e3,n=15,i=document.documentElement,o=0,r=0
flexibility.onresize=function(s){if(i.clientWidth!==o||i.clientHeight!==r){o=i.clientWidth,r=i.clientHeight,clearTimeout(t),window.removeEventListener("resize",flexibility.onresize)
var a=s.target&&1===s.target.nodeType?s.target:document.documentElement
flexibility.walk(a),t=setTimeout(function(){window.addEventListener("resize",flexibility.onresize)},e/n)}}
var s={alignContent:{initial:"stretch",valid:/^(flex-start|flex-end|center|space-between|space-around|stretch)/},alignItems:{initial:"stretch",valid:/^(flex-start|flex-end|center|baseline|stretch)$/},boxSizing:{initial:"content-box",valid:/^(border-box|content-box)$/},flexDirection:{initial:"row",valid:/^(row|row-reverse|column|column-reverse)$/},flexWrap:{initial:"nowrap",valid:/^(nowrap|wrap|wrap-reverse)$/},justifyContent:{initial:"flex-start",valid:/^(flex-start|flex-end|center|space-between|space-around)$/}}
flexibility.updateFlexContainerCache=function(t){var e=t.style,n=t.node.currentStyle,i=t.node.style,o={};(n["flex-flow"]||i["flex-flow"]||"").replace(/^(row|row-reverse|column|column-reverse)\s+(nowrap|wrap|wrap-reverse)$/i,function(t,e,n){o.flexDirection=e,o.flexWrap=n})
for(var r in s){var a=r.replace(/[A-Z]/g,"-$&").toLowerCase(),l=s[r],u=n[a]||i[a]
e[r]=l.valid.test(u)?u:o[r]||l.initial}}
...
flexibility.updateFlexItemCache=function(t){var e=t.style,n=t.node.currentStyle,i=t.node.style,o={};(n.flex||i.flex||"").replace(/^\+?(0|[1-9][0-9]*)/,function(t){o.flexGrow=t})
for(var r in a){var s=r.replace(/[A-Z]/g,"-$&").toLowerCase(),l=a[r],u=n[s]||i[s]
e[r]=l.valid.test(u)?u:o[r]||l.initial,"number"==typeof l.initial&&(e[r]=parseFloat(e[r]))}}
var l="border:0 solid;clip:rect(0 0 0 0);display:inline-block;font:0/0 serif;margin:0;max-height:none;max-width:none;min-height:0;min-width:0;overflow:hidden;padding:0;position:absolute;width:1em;",u={medium:4,none:0,thick:6,thin:2},c={borderBottomWidth:0,borderLeftWidth:0,borderRightWidth:0,borderTopWidth:0,height:0,paddingBottom:0,paddingLeft:0,paddingRight:0,paddingTop:0,marginBottom:0,marginLeft:0,marginRight:0,marginTop:0,maxHeight:0,maxWidth:0,minHeight:0,minWidth:0,width:0},d=/^([-+]?0|[-+]?[0-9]*\.?[0-9]+)/,f=100
flexibility.updateLengthCache=function(t){var e,n,i,o=t.node,r=t.style,s=o.parentNode,a=document.createElement("_"),p=a.runtimeStyle,h=o.currentStyle
p.cssText=l+"font-size:"+h.fontSize,s.insertBefore(a,o.nextSibling),r.fontSize=a.offsetWidth,p.fontSize=r.fontSize+"px"
for(var g in c){var v=h[g]
d.test(v)||"auto"===v&&!/(width|height)/i.test(g)?/%$/.test(v)?(/^(bottom|height|top)$/.test(g)?(n||(n=s.offsetHeight),i=n):(e||(e=s.offsetWidth),i=e),r[g]=parseFloat(v)*i/f):(p.width=v,r[g]=a.offsetWidth):/^border/.test(g)&&v in u?r[g]=u[v]:delete r[g]}s.removeChild(a),"none"===h.borderTopStyle&&(r.borderTopWidth=0),"none"===h.borderRightStyle&&(r.borderRightWidth=0),"none"===h.borderBottomStyle&&(r.borderBottomWidth=0),"none"===h.borderLeftStyle&&(r.borderLeftWidth=0),r.width||r.minWidth||(/flex/.test(r.display)?r.width=o.offsetWidth:r.minWidth=o.offsetWidth),r.height||r.minHeight||/flex/.test(r.display)||(r.minHeight=o.offsetHeight)},flexibility.walk=function(t){var e=flexibility.init(t),n=e.style,i=n.display
if("none"===i)return{}
var o=i.match(/^(inline)?flex$/)
if(o&&(flexibility.updateFlexContainerCache(e),t.runtimeStyle.cssText="display:"+(o[1]?"inline-block":"block"),e.children=[]),Array.prototype.forEach.call(t.childNodes,function(t,i){if(1===t.nodeType){var r=flexibility.walk(t),s=r.style
r.index=i,o&&(flexibility.updateFlexItemCache(r),"auto"===s.alignSelf&&(s.alignSelf=n.alignItems),s.flex=s.flexGrow,t.runtimeStyle.cssText="display:inline-block",e.children.push(r))}}),o){e.children.forEach(function(t){flexibility.updateLengthCache(t)}),e.children.sort(function(t,e){return t.style.order-e.style.order||t.index-e.index}),/-reverse$/.test(n.flexDirection)&&(e.children.reverse(),n.flexDirection=n.flexDirection.replace(/-reverse$/,""),"flex-start"===n.justifyContent?n.justifyContent="flex-end":"flex-end"===n.justifyContent&&(n.justifyContent="flex-start")),flexibility.updateLengthCache(e),delete e.lastLayout,delete e.layout
var r=n.borderTopWidth,s=n.borderBottomWidth
n.borderTopWidth=0,n.borderBottomWidth=0,n.borderLeftWidth=0,"column"===n.flexDirection&&(n.width-=n.borderRightWidth),flexibility.computeLayout(e),t.runtimeStyle.cssText="box-sizing:border-box;display:block;position:relative;width:"+(e.layout.width+n.borderRightWidth)+"px;height:"+(e.layout.height+r+s)+"px"
var a=[],l=1,u="column"===n.flexDirection?"width":"height"
e.children.forEach(function(t){a[t.lineIndex]=Math.max(a[t.lineIndex]||0,t.layout[u]),l=Math.max(l,t.lineIndex+1)}),e.children.forEach(function(t){var e=t.layout
"stretch"===t.style.alignSelf&&(e[u]=a[t.lineIndex]),t.node.runtimeStyle.cssText="box-sizing:border-box;display:block;position:absolute;margin:0;width:"+e.width+"px;height:"+e.height+"px;top:"+e.top+"px;left:"+e.left+"px"})}return e}}()
